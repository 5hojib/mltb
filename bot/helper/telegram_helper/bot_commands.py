...
class _BotCommands:
    def __init__(self):
        ...
        self.JdMirrorCommand = [
            f"jdmirror{Config.CMD_SUFFIX}",
            f"jm{Config.CMD_SUFFIX}",
        ]
        self.YtdlCommand = [f"ytdl{Config.CMD_SUFFIX}", f"y{Config.CMD_SUFFIX}"]
        self.NzbMirrorCommand = [
            f"nzbmirror{Config.CMD_SUFFIX}",
            f"nm{Config.CMD_SUFFIX}",
        ]
        ...
        self.JdLeechCommand = [
            f"jdLeech{Config.CMD_SUFFIX}",
            f"jl{Config.CMD_SUFFIX}",
        ]
        ...
        self.NzbLeechCommand = [
            f"nzbleech{Config.CMD_SUFFIX}",
            f"nl{Config.CMD_SUFFIX}",
        ]
